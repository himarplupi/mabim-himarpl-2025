...
export function HeroSection() {
  ...
  return (
    <section className="bg-[radial-gradient(101.34%_99.57%_at_50.02%_0.43%,#010030_7%,#7226FF_55%,#3243A6_100%)] text-center flex min-h-screen w-full flex-col items-center justify-center gap-y-6 relative">
      ...
      <div className="w-[343px] flex flex-col gap-3 z-[5]">
      ...
      <div className="flex items-center select-none gap-0 relative ">
        ...
        {/* <span className="bg-[radial-gradient(101.34%_99.57%_at_50.02%_0.43%,#010030_7%,#7226FF_55%,#87F5F5_100%)] text-transparent bg-clip-text font-jumbo text-[48.42px]/[44px] absolute right-0 z-[6] tracking-[-16px] [-webkit-text-stroke:0.8px_white] ">
          2K25
        </span> */}

        {/* <span className=" [-webkit-text-stroke:0.8px_white] text-transparent font-jumbo text-[48.42px]/[44px] absolute right-0 z-[6] tracking-[-16px]">2K25</span>
        <span className="bg-[radial-gradient(101.34%_99.57%_at_50.02%_0.43%,#010030_7%,#7226FF_55%,#87F5F5_100%)] text-transparent bg-clip-text font-jumbo text-[48.42px]/[44px] absolute right-0 z-[6] tracking-[-16px]">2K25</span> */}
      </div>

      <Image src={OrnamentPattern} alt="ornaments" className="absolute bottom-0 left-0 w-full h-fit z-[1]" />
      <div className="absolute bottom-0  bg-gradient-to-b from-[#010030] to-[#030096] w-full h-[234px] rounded-full blur-2xl"></div>
    </section>
  );
}
