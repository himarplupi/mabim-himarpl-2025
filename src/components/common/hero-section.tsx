    ...
    <section className="bg-[radial-gradient(101.34%_99.57%_at_50.02%_0.43%,#010030_7%,#7226FF_55%,#3243A6_100%)] text-center flex min-h-[1000px] h-screen w-full flex-col items-center justify-center gap-y-6 relative overflow-hidden px-4">
      ...
      <div className="max-w-[343px] sm:hidden z-[5] mt-20">
        ...
        <FlashingText 
          ...
          flashLength={150} 
          flashThickness={4} 
          className="font-ethno text-white text-[32px] [text-shadow:0_0_8px_#8166E3]" 
        />
      </div>
      {/* Desktop Headline */}
      <div className="max-w-[840px] hidden sm:block z-[5] mt-60">
        <h1 className="font-ethno text-white sm:text-[46px] lg:text-[58px] [text-shadow:0_0_8px_#8166E3]">
          EXPLORING MABIM WITH FUTURE TECH
        </h1>
      </div>
      {/* Description */}
      <div className="w-full max-w-[343px] md:max-w-[680px] flex flex-col gap-3 z-[6]">
        <h4 className="font-montserrat text-[16px] md:text-[20px] text-white font-semibold">
          &quot;Cyber Root: Menembus Dunia Digital, Berakar Dalam Jati Diri&quot;
        </h4>
      ...
      <div className="w-full flex justify-center relative">
        <Image src={SmileMascot2} alt="Mascot" className="w-[360px] z-[6] absolute left-20 bottom-0 hidden xl:block" />
        ...
        <div className="flex items-center justify-center select-none gap-0 relative">
          ...
          <div className="z-[3] leading-none -ml-12 md:-ml-18 lg:-ml-22 relative">
            <p className="font-montserrat font-black bg-gradient-to-r from-white/50 via-white to-white/50 bg-clip-text text-transparent text-[52px] md:text-[62px] lg:text-[96px] z-[1] text-start left-[160px] mr-15">
              MABIM
            </p>
            <span className="flex items-baseline">
              <p className="font-montserrat font-black bg-gradient-to-r from-white/50 via-white to-white/50 bg-clip-text text-transparent text-[52px] md:text-[62px] lg:text-[96px] z-[1] text-start left-[160px]">
                RPL
              </p>
        ...
        <Image src={SmileMascot3} alt="Mascot" className="w-[380px] z-[6] absolute right-15 -top-5 hidden xl:block" />
      </div>
