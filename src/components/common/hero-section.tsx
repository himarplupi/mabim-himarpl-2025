...
export function HeroSection() {
  ...
  return (
    <section className="bg-[radial-gradient(101.34%_99.57%_at_50.02%_0.43%,#010030_7%,#7226FF_55%,#3243A6_100%)] text-center flex min-h-[812px] h-screen w-full flex-col items-center justify-center gap-y-6 relative overflow-hidden px-4">
      
      {/* Mobile Headline */}
      <div className="max-w-[343px] sm:hidden z-[5]">
      ...
      {/* Desktop Headline */}
      <div className="max-w-[840px] hidden sm:block z-[5]">
      ...
      <div className="w-full flex justify-center ">
        <div className="flex items-center justify-center select-none gap-0 relative bg-amber-500">
          
          <Image src={SmileMascot} alt="Mascot" className="w-[204px] sm:w-[204px] md:w-[260px] lg:w-[280px] h-auto z-[6]" />
