...
export function CountdownSection() {
  return (
    <section
      id="countdown"
      className="bg-[radial-gradient(101.34%_99.57%_at_50.02%_0.43%,#010030_7%,#7226FF_55%,#3243A6_100%)] text-center flex h-screen min-h-[812px] w-full flex-col items-center pt-[120px] relative overflow-clip px-2 md:px-6"
    >
      <h3 className="font-ethno text-white text-[40px] z-[6] md:text-[60px]  mb-5">COUNTDOWN</h3>
