...
export function CountdownSection() {
  return (
    <section className="bg-[radial-gradient(101.34%_99.57%_at_50.02%_0.43%,#010030_7%,#7226FF_55%,#3243A6_100%)] text-center flex min-h-screen h-[812px] w-full flex-col items-center pt-[120px] relative overflow-clip">
