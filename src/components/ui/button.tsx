...
export const Button = ({ title, classN, ...props }: ButtonProps) => {
  return (
    <div className=" p-[6px] z-[6]">
      <button
        {...props}
        className={cn("relative w-[110px] hover:scale-105 cursor-pointer transition-all duration-300 ease-in-out bg-gradient-to-r py-2 from-[#010030]/80 via-[#020063]/50 to-[#010030]/80 flex items-center justify-center", classN)}
      >
